...
import com.github.pmvieira93.gateway.infrastructure.filter.factory.ApiVersionValidationGatewayFilterFactory.Config;
	...
	public RouteLocator customRouteLocator(RouteLocatorBuilder builder,
		...
		return builder.routes()
				...
				.route("code_rewrite_route", r -> r.host("*.rewrite.org")
						...
						.uri("http://httpbin.org"))
				/*
				 * .route("code_hystrix_route", r -> r.host("*.hystrix.org")
				 * .filters(f -> f.hystrix(c -> c.setName("slowcmd")))
				 * .uri("http://httpbin.org"))
				 * .route("code_hystrix_fallback_route", r -> r.host("*.hystrixfallback.org")
				 * .filters(f -> f.hystrix(c ->
				 * c.setName("slowcmd").setFallbackUri("forward:/hystrixfallback")))
				 * .uri("http://httpbin.org"))
				 * .route("code_limit_route", r -> r
